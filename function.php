			...
			<div class='product-image-wrapper'>
				<div class='single-products'>
					<div class='productinfo text-center'>
						<img src='admin/images/$image' height='340' alt='' >
						<h2><span>Rp </span>$price</h2>
						<p>$name</p>
			...
			<div class='col-xs-8 col-xs-offset-2'>
				<form class='form-horizontal' role='form' enctype='multipart/form-data' action='function.php' method='post'>
					...
					<div class='form-group'>
					    ...
					    <input type='hidden' class='form-control' id='get_image' name='get_image' value='$user_i'>
...
if(isset($_POST['save'])){
	...
	if($u_i != ""){
	    ...
	    unlink('images/user_images/'.$u_getimage);
	}else{
