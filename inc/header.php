					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li class="dummy"><a href="javascript:void(0)"><i class="fa fa-envelope"></i> info@rioshop.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.php"><img src="images/home/rioshop.png" alt="" height="100px"/></a>
						</div>
					</div>
					<div class="col-sm-8">
