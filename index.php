			...
			<div class="col-sm-9 padding-right">
				<div class="features_items"><!--features_items-->
					...
					while($row=mysqli_fetch_array($run)){
						...
						$name = $row['p_name'];
						$image = $row['p_image'];
						$price = rupiah($row['p_price']); ?>
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="admin/images/<?php echo $image; ?>" height="340" alt="" >
										<h2><span>Rp </span><?php echo $price; ?></h2>
										<p><?php echo $name; ?></p>
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade" id="blazers" >
							...
							while($blaz = mysqli_fetch_array($run_blaz)){
								...
								$name = $blaz['p_name'];
								$image = $blaz['p_image'];
								$price = rupiah($blaz['p_price']) ?>
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="admin/images/<?php echo $image; ?>" height="340" height="340" alt="" />
												<h2><span>Rp </span><?php echo $price; ?></h2>
												<p><?php echo $name; ?></p>
												<a href="javascript:void(0)" class="btn btn-default add-to-cart" onclick="cart(<?php echo $id; ?>)"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											    <a href="<?php echo $add_wish ?>" class="btn btn-default add-to-cart wish" data-user="<?php echo $s_email; ?>" onclick="wish(<?php echo $id; ?>)"><i class="glyphicon glyphicon-heart"></i> Wishlist</a>
