			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					while($row=mysqli_fetch_array($run)){
						...
						<div class="row">
							...
							<div class="col-xs-7 col-lg-6">
								<div class="col-xs-4 col-lg-6 text-right">
									<h6><strong>Rp <?php echo $price; ?> <span class="text-muted">x</span></strong></h6>
								</div>
						...
						<hr>
					<?php } 
					$gettotal = rupiah($total);
					?>
				</div>
				<div class="panel-footer">
					<div class="row text-center">
						<div class="col-xs-6 col-lg-9">
							<h4 class="text-right">Total&nbsp; Rp <strong><?php echo $gettotal; ?></strong></h4>
						</div>
						<div class="col-xs-6 col-lg-3">
							<a href="<?php echo $checkout; ?>.php"><button type="button" class="btn btn-success btn-block" id="check_btn">Checkout</button></a>
						</div>
					</div>
				</div>
			</div>
