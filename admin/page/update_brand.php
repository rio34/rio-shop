...
<body>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <div class="col-sm-9 col-sm-offset-1 col-lg-10 col-lg-offset-1 main">
        ...
        <h3>Edit Nama Brand</h3>
        <?php 
        $edit = $_GET['edit'];
        $data = mysqli_query($connect, "SELECT * FROM brand WHERE id='$edit'");
        while($row = mysqli_fetch_array($data)){
        ?>
          <form class="form-horizontal"  method="post" action="edit_brand.php" onkeypress="return disableEnterKey(event)">
            <div class="form-group">
              <label for="id_brand" class="col-lg-3 control-label">ID Brand:</label>
              <div class="col-lg-8">
            ...
            <div class="form-group">
              <label for="title_brand" class="col-lg-3 control-label">Title Brand:</label>
              <div class="col-lg-8">
                <input name="brand" class="form-control" type="text" value="<?php echo $row['title']; ?>">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-8">
                ...
                <a href="brand.php" class="btn btn-danger"><i class="fa fa-arrow-circle-left"></i> Back</a>
            </div>
          </form>
        <?php } ?>
      </div>
