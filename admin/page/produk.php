...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="produk.php"><em class="fa fa-product-hunt">&nbsp;</em> Products</a></li>
            ...
            <div class="panel panel-default panel-table">
                  ...
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Data Produk</h3>
             	 	...
             	 	<div class="col-xs-3 col-md-3 col-lg-3">
              			<a href="tambah_produk.php" class="btn btn-default"><em class="fa fa-plus"></em> Tambah Produk</a>
			  		</div>
                </div>
              </div>
              <div class="panel-body">
                <table class="table table-striped table-bordered table-list">
	                ...
	                <tbody>
	                    <?php $no=1;
                    	$tampil = mysqli_query($connect, "SELECT * FROM product order by id asc");
	                    $no=1;
	                    foreach ($tampil as $row){
	                    	...
	                    	<td>".$row['p_qty']."</td> " ?>
	                    	<td align="center">
	                          <a href="update_produk.php?edit=<?php echo $row['id']; ?>" class="btn btn-primary"><em class="fa fa-pencil"></em></a>
	                          <a data-href="delete_produk.php?hapus=<?php echo $row['id']; ?>" data-toggle='modal' data-target='#konfirmasi_hapus' class="btn btn-danger"><em class="fa fa-trash"></em></a>
	                        </td>
	                    	</tr><?php
	                    	$no++;
	                    }?>
