...
<body>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <div class="col-sm-9 col-sm-offset-1 col-lg-10 col-lg-offset-1 main">
        ...
        <?php 
        $edit = $_GET['edit'];
        $data = mysqli_query($connect, "SELECT * FROM category WHERE id='$edit'");
        while($row = mysqli_fetch_array($data)){
        ?>
          <form class="form-horizontal"  method="post" action="edit_kategori.php" onkeypress="return disableEnterKey(event)">
            <div class="form-group">
              <label for="id_kategori" class="col-lg-3 control-label">ID Kategori:</label>
              <div class="col-lg-8">
            ...
            <div class="form-group">
              <label for="title_brand" class="col-lg-3 control-label">Name Kategori:</label>
              <div class="col-lg-8">
                <input name="kategori" class="form-control" type="text" value="<?php echo $row['name']; ?>">
              </div>
            </div>
            <div class="form-group">
