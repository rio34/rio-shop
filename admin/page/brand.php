...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="brand.php"><em class="fa fa-bitbucket">&nbsp;</em> Brands</a></li>
            ...
            <div class="panel panel-default panel-table">
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Data Brands</h3>
                  </div>
              		<div class="col-xs-3 col-md-3 col-lg-3">
              			<a href="tambah_brand.php" class="btn btn-default"><em class="fa fa-plus"></em> Tambah Brand</a>
			  		</div>
                </div>
              </div>
              <div class="panel-body">
                <table class="table table-striped table-bordered table-list">
	                ...
	                <tbody>
	                	<?php $no=1;
	                    $tampil = mysqli_query($connect, "SELECT * FROM brand order by id asc");
	                    foreach ($tampil as $row){
	                    	...
	                    	<td>".$row['title']."</td> " ?>
	                    	<td align="center">
	                          <a href="update_brand.php?edit=<?php echo $row['id']; ?>" class="btn btn-primary"><em class="fa fa-pencil"></em></a>
	                          <a data-href="delete_brand.php?hapus=<?php echo $row['id']; ?>" data-toggle='modal' data-target='#konfirmasi_hapus' class="btn btn-danger"><em class="fa fa-trash"></em></a>
	                        </td>
	                    	</tr><?php
	                     $no++; } ?>
                  	</tbody>
