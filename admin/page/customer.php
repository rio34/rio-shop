...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="customer.php"><em class="fa fa-automobile">&nbsp;</em> Customers</a></li>
            ...
            <div class="panel panel-default panel-table">
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Data Customers</h3>
                  </div>
              		<div class="col-xs-3 col-md-3 col-lg-3">
              			<a href="tambah_customer.php" class="btn btn-default"><em class="fa fa-plus"></em> Tambah Customers</a>
			  		</div>
                </div>
              </div>
              <div class="panel-body">
                <table class="table table-striped table-bordered table-list">
	                ...
	                <tbody>
	                    <?php $no=1;
                    	$tampil = mysqli_query($connect, "SELECT * FROM customer order by c_id asc");
	                    foreach ($tampil as $row){
	                    	...
	                    	<td>".$row['c_email']."</td> " ?>
	                    	<td align="center">
	                          <a href="update_customer.php?edit=<?php echo $row['c_id']; ?>" class="btn btn-primary"><em class="fa fa-pencil"></em></a>
	                          <a data-href="delete_customer.php?hapus=<?php echo $row['c_id']; ?>" data-toggle='modal' data-target='#konfirmasi_hapus' class="btn btn-danger"><em class="fa fa-trash"></em></a>
	                        </td>
	                    	</tr><?php
	                    	$no++;
	                    }?>
