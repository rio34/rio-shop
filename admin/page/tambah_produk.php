	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Tambah Products</li>
			</ol>
		</div><!--/.row-->
		<div class="col-sm-9 col-sm-offset-1 col-lg-10 col-lg-offset-1 main">
	        <h3>Tambah Data Products</h3>
	        <form class="form-horizontal" enctype="multipart/form-data" method="post" action="t_produk.php" onkeypress="return disableEnterKey(event)">
	          <div class="form-group">
	            <label for="nama_produk" class="col-lg-3 control-label">Nama Produk:</label>
	            <div class="col-lg-8">
	              <input name="p_name" class="form-control" type="text" value="" placeholder="Masukkan nama produk" required="">
	            </div>
	          </div>
	          <div class="form-group">
	            ...
	            <div class="col-lg-8">
	              <select name="p_cat" class="form-control" required="">
	                <option value="">Silahkan pilih</option>
		              <?php 
		              $q = mysqli_query($connect, 'SELECT * FROM category ORDER BY id asc');
		              foreach ($q as $p) {
	          ...
	          <div class="form-group">
	            ...
	            <div class="col-lg-8">
	              <select name="p_sub" class="form-control" required="">
	                <option value="">Silahkan pilih</option>
		              <?php 
		              $q = mysqli_query($connect, 'SELECT * FROM sub_category ORDER BY id asc');
		              foreach ($q as $p) {
		                echo "<option value=$p[id]>$p[name]</option>";
		              } ?>
	            </select>
	          ...
	          <div class="form-group">
	            ...
	            <div class="col-lg-8">
	              <select name="p_brand" class="form-control" required="">
	                <option value="">Silahkan pilih</option>
		              <?php 
		              $q = mysqli_query($connect, 'SELECT * FROM brand ORDER BY id asc');
		              foreach ($q as $p) {
	          ...
	          <div class="form-group">
	            ...
	            <div class="col-lg-8">
	              <input name="p_price" class="form-control" type="number" value="" placeholder="Masukkan harga" required="">
	            </div>
	          </div>
	          <div class="form-group">
	            <label for="desc" class="col-lg-3 control-label">Deskripsi:</label>
	            <div class="col-lg-8">
	              <textarea class="form-control" name="p_desc" rows="10" cols="15" required=""></textarea>
	            </div>
	          </div>
	          <div class="form-group">
	            <label for="Jumlah" class="col-lg-3 control-label">Jumlah:</label>
	            <div class="col-lg-8">
	              <input name="p_qty" class="form-control" type="number" value="" placeholder="Masukkan jumlah" required="">
	            </div>
	          </div>
	          <div class="form-group">
	          	<label for="image" class="col-lg-3 control-label">Product Image:</label>
	          	<div class="col-lg-8">
