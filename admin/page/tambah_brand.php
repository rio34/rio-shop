...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <form class="form-horizontal"  method="post" action="t_brand.php" onkeypress="return disableEnterKey(event)">
          <div class="form-group">
            <label for="nama_brand" class="col-lg-3 control-label">Nama Brand:</label>
            <div class="col-lg-8">
              <input name="brand" class="form-control" type="text" value="" placeholder="Masukkan nama brand" required="">
            </div>
          </div>
          <div class="form-group">
