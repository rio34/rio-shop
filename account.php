...
<div class="col-lg-12 col-sm-12 col-xs-12">
    <div class="card hovercard">
        ...
        <div class="card-info"> 
            <span class="card-title"><?php echo $n; ?></span>
        </div>
    </div>
            ...
            <div class="tab-pane fade in" id="tab2">
                <div class="row">
                    ...
                    while($fetch = mysqli_fetch_array($run_total)){
                        ...
                        $order_amt = rupiah($fetch['total_amount']);
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 "> 
                    				    ...
                    				    <h5 style="text-decoration:<?php echo $text_decoration; ?>"><span class="glyphicon glyphicon-star"></span>&nbsp;Total Amount : Rp <?php echo $order_amt; ?></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-footer">
